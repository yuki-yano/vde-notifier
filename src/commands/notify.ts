...
import { asNonEmptyString, defaultAgentTitle, readStdin, type AgentContext as CodexContext } from "../agents/context";
import { parseCodexContext } from "../agents/codex";
import { loadClaudeContext } from "../agents/claude";
import { flagOnlyOptions, optionsWithValue } from "../cli/arguments";
import { appendDiagnosticLog, logVerbose } from "../diagnostics/logging";
import { sendNotification } from "../notify/send";
import { resolveTerminalProfile } from "../terminal/profile";
import { resolveTmuxContext } from "../tmux/query";
import { buildFocusCommand } from "../utils/payload";
import { logBinaryReport, verifyRequiredBinaries, verifyTmuxBinary } from "../utils/runtime";
...
export const loadCodexContext = async (
...
export const resolveNotificationDetails = (
  tmux: TmuxContext,
  options: CliOptions,
  ...
  return {
    title,
    message,
    sound: options.sound ?? context?.sound
  };
};
